...
python eval.py    --resume _saved_PA/models/LA_SENet12_LPSseg_uf_seg600/20201012_223454/checkpoint-epoch2.pth \
                  ...
                  --device 0
# python eval.py    --resume _saved/models/LA_SENet12_LPSseg_uf_seg600/20200414_183411/checkpoint-epoch1.pth --protocol_file data_LA/ASVspoof2019_LA_cm_protocols/ASVspoof2019.LA.cm.eval.trl.txt --asv_score_file data_LA/ASVspoof2019_LA_asv_scores/ASVspoof2019.LA.asv.eval.gi.trl.scores.txt --device 0
...
# python eval.py    --resume _saved/models/LA_lcnnSmall_LPSseg_uf_seg600_noEmph/20200421_005928/model_best.pth \
#                   --protocol_file data_LA/ASVspoof2019_LA_cm_protocols/ASVspoof2019.LA.cm.eval.trl.txt \
#                   --asv_score_file data_LA/ASVspoof2019_LA_asv_scores/ASVspoof2019.LA.asv.eval.gi.trl.scores.txt \
#                   --device ${GPU}
