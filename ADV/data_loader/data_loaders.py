...
class SpoofDataLoaderBalanceSample(BaseDataLoader):
    #="D:/AdvAttacksASVspoof/data_LA/ASVspoof2019_LA_cm_protocols/ASVspoof2019.PA.cm.train.trn.txt"
    def __init__(self, scp_file, data_dir, batch_size, protocol_file="/home/jiangziyue/dat01/LA/ASVspoof2019_LA_cm_protocols/ASVspoof2019.LA.cm.train.trn.txt", shuffle=True, validation_split=0.0, num_workers=1, eval=False, read_protocol=True):
