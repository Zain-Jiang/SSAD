import numpy as np
import librosa
from pase.ASV_FeatureExtraction.generic import stft, load_wav, preemphasis, load_wav_snf
...
def logpowspec(wav, sr=16000, n_fft=1724, hop_length=130, win_length=1724, window="blackman", pre_emphasis=None, ref=1.0, amin=1e-30, top_db=None):
    """Compute log power magnitude spectra (logspec).
