...
import os
import sys
sys.path.append(r'C:/Users/jzy/Desktop/课程/信安竞赛/PASE+/pase')
...
# Reading inputs
pase_cfg = "../cfg/frontend/PASE+.cfg"  # e.g, '../cfg/frontend/PASE+.cfg'
pase_model = "C:/Users/jzy/Desktop/课程/信安竞赛/PASE+/FE_e199.ckpt"  # e.g, '../FE_e199.ckp' (download the pre-trained PASE+ model as described in the doc)
data_folder = "D:/TIMIT_dataset/data/lisa/data/timit/raw/TIMIT"  # e.g., '/home/mirco/Dataset/TIMIT'
output_folder = 'TIMIT_asr_exp'  # e.g., 'TIMIT_asr_exp'
cfg_file = "cfg/MLP_pase.cfg"  # e.g, cfg/MLP_pase.cfg
cfg_dec = "cfg/decoder.cfg"  # e.g., cfg/decoder.cfg
